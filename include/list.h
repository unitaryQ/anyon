...
static inline void list_init(list_t*)__attribute__((always_inline));
static inline void list_add(list_t*, list_t*)__attribute__((always_inline));
static inline void list_del(list_t*)__attribute__((always_inline));
